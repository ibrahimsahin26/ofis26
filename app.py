...
# --- Ürün Ekle ---
    ...
    with st.form("urun_formu"):
        ...
        st.markdown(f"💰 Önerilen Satış Fiyatı: **{satis} TL**")
        ...
        ekle = st.form_submit_button("Ürünü Kaydet")
...
# --- Stok Sayımı ---
    ...
    if not eslesen.empty:
        ...
        mevcut = int(urun.get("Güncel Stok", 0)) if pd.notna(urun.get("Güncel Stok", 0)) else 0
        fark = toplam - mevcut
